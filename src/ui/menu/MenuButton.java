...
public class MenuButton {
    ...
    public static void renderBackground(Graphics2D g) {
        ...
        bg.update();   // FIX: was never updated — stars were frozen
        bg.render(g, 0, 0, LayoutConfig.WINDOW_WIDTH, LayoutConfig.WINDOW_HEIGHT);
    }
    ...
    public void render(Graphics2D g) {
        ...
        int drawX = (LayoutConfig.WINDOW_WIDTH - fm.stringWidth(display)) / 2;
    ...
    public static void drawSectionLabel(Graphics2D g, String text, int cx, int y) {
        ...
        g.fillRect(lx - 30, y - 4, 24, 1);
        g.fillRect(lx + tw + 6, y - 4, 24, 1);
